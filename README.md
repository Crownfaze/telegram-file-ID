...
Тип: photo file_id: AgACAgIAAxkBAAIB... очень длинная строка ... file_unique_id: AgACAgIAAxkBAAIB... Размер: 1.8 МБ Ширина × Высота: 1280 × 960 или для видео/документа аналогично. Где и как потом использовать file_id?
...
wait bot.send_photo(chat_id, photo="AgACAgIAAxkBAAIB...длинная строка...")
